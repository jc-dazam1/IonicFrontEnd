    ...
    stages {
        stage('Checkout') { 
            steps {
                ...
                url: 'https://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@github.com/MISW-4102-ProcesosDeDesarrolloAgil/' + env.GIT_REPO
            }
        }
        stage('Gitinspector') {
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: env.GIT_CREDENTIAL_ID, passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
                    ...
                    sh('git pull https://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@github.com/MISW-4102-ProcesosDeDesarrolloAgil/${GIT_REPO} main')
                    sh('git push https://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@github.com/MISW-4102-ProcesosDeDesarrolloAgil/${GIT_REPO} main')
                }  
            }
        }
